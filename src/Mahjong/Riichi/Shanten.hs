...
data Shanten
  ...
  | SixFrom
    ...
    -- possible hand of 13 tiles that have no iteraction with each other, then
...
-- | By color graphing the possible melds and waits we can determine how far a
-- Hand is from Tenpai or winning.
--countShanten :: Hand -> Shanten
